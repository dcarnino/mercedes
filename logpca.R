...
binary_train <- read_csv("../data/binary_train.csv")
binary_test <- read_csv("../data/binary_test.csv")
...
write.csv(logpca_features_train, file="../data/logpca_train.csv", row.names=FALSE)
write.csv(logpca_features_test, file="../data/logpca_test.csv", row.names=FALSE)
