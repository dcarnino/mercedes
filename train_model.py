...
def main(verbose=1):
    ...
    for ix_cv in range(n_total):
        ...
        for valtrain_index, valtest_index in cv.split(Xb_train.values):
            ...
            mask_no_outliers = (id_valtrain == 2903) | (id_valtrain == 2511) | (id_valtrain == 681) | (id_valtrain == 505) | (id_valtrain == 1784) | (id_valtrain == 2396) | (id_valtrain == 5820) | (id_valtrain == 7500)
            ...
            reg = stacked_regressor(define_model.create_layer0, define_model.create_layer1, define_model.create_layer2,
                                    ...
                                    remove_bad0=0.1, remove_bad1=0.1,
                                    n_folds0=8, n_folds1=8, n_est0=892, n_est1=2240, score_func=metrics.r2_score,
            ...
            reg = correlation_ensembling(estimator_list, keep_p=0.1)
            reg.fit(X1_valtrain, y_valtrain, verbose=1)
